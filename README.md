# 💳 NexumBank — Banco Digital (Em Desenvolvimento)
...
```bash
git clone https://github.com/gabrielleiteleal/nexumbank.git
cd nexumbank
```
...
Esse processo reflete um ambiente próximo ao desenvolvimento real utilizado em equipes profissionais.
